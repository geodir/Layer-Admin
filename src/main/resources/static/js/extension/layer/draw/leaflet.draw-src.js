...
L.drawLocal = {
	draw: {
		...
		handlers: {
			...
			marker: {
				tooltip: {
					start: 'Hacer click en el mapa.'
				}
			},
			polygon: {
				tooltip: {
					start: 'Haga clic para iniciar.',
					cont: 'Clic para continuar la edición.',
			...
			polyline: {
				...
				tooltip: {
					...
					cont: 'Click para continuar la medición',
					end: 'Doble click para finalizar'
				}
			},
			rectangle: {
				tooltip: {
			...
			simpleshape: {
				tooltip: {
					end: 'Suelte el ratón para completar el dibujo.'
				}
			}
		}
	},
